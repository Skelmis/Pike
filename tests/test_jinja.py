...
def test_insert_image(engine: Engine):
    ...
    r_3 = insert_image("cat.jpg", width=100, height=100, alt_text="Alt Text", caption="Caption")
    assert r_3  == "<img src='cat.jpg' alt='Alt Text' width='100' height='100' title='Caption'>"